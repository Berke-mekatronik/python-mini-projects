...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        #Canvas
        self.canvas = Canvas(width=203, height=230)
        self.question_text = self.canvas.create_text(101,115, width=150,text="Some Question Text", fill=THEME_COLOR, font=("Arial",12,"italic"))
